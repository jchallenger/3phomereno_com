  ...
  <div class="collapse navbar-toggleable-xs" id="exCollapsingNavbar2">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="nav-item <?php echo $active; ?>">
        ...
        <?php if($active) { ?><span class="sr-only">(current)</span><?php } ?></a>
      </li>

      <?php $active = ($this->router->fetch_class() == 'offerings' )? 'active' : false; ?>
      <li class="nav-item dropdown <?php echo $active; ?>">
        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Offerings 
        <?php if($active) { ?><span class="sr-only">(current)</span><?php } ?></a>
      ...
      <li class="nav-item <?php echo $active; ?>">
        <a class="nav-link" href="<?php echo base_url(); ?>pricing">Pricing 
        <?php if($active) { ?><span class="sr-only">(current)</span><?php } ?></a>
      </li>
